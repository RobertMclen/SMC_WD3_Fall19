...
const car = document.getElementById("js-car");
...
function updatecar(picker, string) {
  if (!string) {
  car.style.fill = picker.toHEXString();
    } else {
      // Used when generating random
      car.style.fill = string;
     setTimeout(function(){car.classList.remove("fade");}, 700); 
    }
}
